...
- Used academic tools like R programming language, probability theory, and modeling and simulation concepts for the execution of the entire project.
...
- Adopted the M/M/C queuing model to visualize the changes in the environment, thereby minimizing the wait time.
